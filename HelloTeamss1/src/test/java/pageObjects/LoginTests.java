...
public class LoginTests extends BaseTest {
    ...
    public void verifyLoginWithValidCredentials() throws InterruptedException {
        ...
        OrganizationDashboardPO organizationDashboardPO = new OrganizationDashboardPO(driver);
        ...
        Assert.assertEquals(organizationDashboardPO.getTextCreateOrganization(), expectedResult, "User is not able to login successfully");
    ...
    public void verifyLoginWithInvalidCredentials() throws InterruptedException {
        ...
        Reporter.log("Entering invalid sign in details and login to application");
        loginPO.fillLoginDetailsAndPerformLogin("piyush@test.com", "11111");
    ...
    /*Test 3 : Verify that user can't login without confirm pageObjects.helloTeams.account*/
    @Test
    public void verifyLoginWithoutConfirmAccount() throws InterruptedException {
        ...
        Reporter.log("Step 2 - Entering details without confirming pageObjects.helloTeams.account and login to application");
        loginPO.fillLoginDetailsAndPerformLogin("piyush+11@helloteams.io", "Piyush+10");

        Reporter.log("Steps 3 - Verify that validation message is displayed");
        String expectedErrorMessage = "Invalid email address or password";
        Assert.assertEquals(loginPO.getInvalidDataValidationMessage(), expectedErrorMessage, "Error Message doesn't match");
    }
    ...
    public void verifyForgotPasswordLinkWorkProperly() throws InterruptedException {
        ...
        Reporter.log("Steps 1 - Navigate to admin login page");
        selenium.navigateToPage(Constants.URL + "/login");

...
public class RegistrationTests extends BaseTest {
    ...
    public void verifySignUpWithValidDetail() throws InterruptedException {
        ...
        selenium.navigateToPage(Constants.URL + "/register");
        ...
        Assert.assertEquals("Hi, Friend", header.getProfileName(), "Logged in user name doesn't match");
    }
    ...
    public void verifyThatAlreadyHaveAccountLinkWorkAsExcepted() throws InterruptedException {
        ...
        String expectedUrl = Constants.URL + "/login";
